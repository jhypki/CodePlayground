...
public class RustHandler : ILanguageHandler
{
    public string GetDockerImage()
    {
        return "code-playground/rust";
    }
    ...
    public string GetExecutionCommand(string code)
    {
        ...
        var runCommand = $"mkdir -p /code && echo \"{base64Code}\" | base64 -d > /code/main.rs && cd /code && rustc main.rs && ./main";
